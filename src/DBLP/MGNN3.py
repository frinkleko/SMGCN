...
edge_index7, w7 = mm_sparse_w(edge_index4, edge_index1, num_nodes)
edge_index8, w8 = mm_sparse_w(edge_index5, edge_index2, num_nodes)
edge_index9, w9 = mm_sparse_w(edge_index6, edge_index3, num_nodes)
...
for run in range(1):
    ...
    for epoch in range(1, 301):
        ...
        out = model(data['author'].x, edge_index1, edge_index2, edge_index3,
                    edge_index4, edge_index5, edge_index6, edge_index7,
                    edge_index8, edge_index9, edge_index_id, w1, w2, w3, w4,
                    w5, w6, w7, w8, w9, w_id)
