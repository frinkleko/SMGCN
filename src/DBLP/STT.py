...
edge_index7, w7 = mm_sparse_w(edge_index1, T22, w1, wt22, num_nodes)
edge_index8, w8 = mm_sparse_w(edge_index2, T22, w2, wt22, num_nodes)
edge_index9, w9 = mm_sparse_w(edge_index3, T22, w3, wt22, num_nodes)




edge_index_id = torch.tensor(np.arange(data['paper'].x.size(0)),
...
for run in range(1):
    ...
    for epoch in range(1, 501):
        ...
        out = model(data['author'].x, edge_index_id, edge_index1, edge_index2,
                    ...
                    edge_index7, edge_index8, edge_index9,  w_id, w1, w2, w3, w4, w5, w6,
                    w7, w8, w9)
